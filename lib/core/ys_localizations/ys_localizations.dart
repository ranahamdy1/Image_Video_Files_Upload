...
// Init
  static String defaultLanguageCode = 'en'; //ar
  ...
  static String? translate(String key) {
    if (YsLocalizations.transSourceType == 'map') {
      return ylocalizedstringMap[key] ?? key;
    } else if (YsLocalizations.transSourceType == 'asset') {
      return ylocalizedstringAsset[key] ?? key;
    } else {
      return key;
    }
  }
...
extension TranslateX on String {
  String get tr {
    return YsLocalizations.translate(this) ?? this;
  }
}
